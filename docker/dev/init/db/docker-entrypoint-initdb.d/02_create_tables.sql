...
--
DROP TABLE IF EXISTS LIB10.user;
...
--  KEY `FKxxm1yc1xty3qn1pthgj8ac4f` (`user_id`),
  ...
  CONSTRAINT loan_user_fk FOREIGN KEY (user_id) REFERENCES LIB10.user (id)
...
--  KEY `FKirxtcw4s6lhwi6l9ocrk6bjfy` (`book_id`),
 -- KEY `FKm4oimk0l1757o9pwavorj6ljg` (`user_id`),
  ...
  CONSTRAINT reservation_user_fk FOREIGN KEY (user_id) REFERENCES LIB10.user (id)
